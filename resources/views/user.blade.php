              ...
              <div class="adv-table">
                <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered table-striped table-advance table-hover" id="hidden-table-info">
                    ...
                    <tr>
                        ...
                        @else
                          <td><span class="label label-inverse label-mini">admin</span></td>
                        @endif
                  ...
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span class="help-inline">089123456789</span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="tgl_valid" class="form-control form-control-inline input-medium default-date-picker" size="16" type="text"/>
              ...
              <div class="modal-body">
                ...
                <form action="#" class="form-horizontal" method="POST" action="{{ url('/user') }}">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Tanggal Valid</label>
                        <div class="col-sm-10">
                            <input disabled="" class="form-control form-control-inline input-medium default-date-picker" size="16" type="text" value="" />
                            <span class="help-block">Select date</span>
                        </div>
                    </div>
...
<script type="text/javascript">
  ...
  function fnFormatDetails ( oTable, nTr )
  {
      ...
      sOut += '<tr><td>No. NRP:</td><td>'+aData[7]+'</td></tr>';
      sOut += '<tr><td>No. BK:</td><td>'+aData[8]+'</td></tr>';
      sOut += '<tr><td>No. Sijil:</td><td>'+aData[9]+'</td></tr>';
      sOut += '<tr><td>Sertifikat:</td><td>'+aData[10]+'</td></tr>';
      sOut += '<tr><td>Tanggal Valid:</td><td>'+aData[11]+'</td></tr>';
      sOut += '</table>';
